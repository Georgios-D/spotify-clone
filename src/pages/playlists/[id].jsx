        ...
        return (
            <Layout>
                <h2 className="px-4 py-16 text-center text-3xl font-bold md:text-5xl">
                    Something went wrong, unable to get playlist
                </h2>
                    ...
                    {isLoading
                        ? Array(20)
                              ...
                              .map((_, index) => (
                                  <div
                                      key={index}
                                      className="grid animate-pulse grid-cols-[auto_1fr_auto] items-center gap-3 py-1.5 px-6 text-sm md:grid-cols-[auto_1fr_1fr_auto]"
                                  >
                                      <div className="w-8">
                                      ...
                                      <div className="mb-2 h-4 w-2/6 bg-neutral-600 max-md:hidden"></div>
                                      <div className="mb-2 h-4 w-10 bg-neutral-600"></div>
                                  </div>
                              ))
